...
class Application(tk.Tk):
    ...
    def __init__(self):
        ...
        self.lbl_jmeno_grafu = tk.Label(self, text = "Trom: ")
        self.lbl_jmeno_grafu.grid(row = 1, column = 1, sticky = "w")
        self.entry_jmeno_grafu = tk.Entry(self, width = 30, textvariable = self.var_krivka)
        self.entry_jmeno_grafu.grid(row = 1, column = 2)

        self.lbl_amplituda = tk.Label(self, text = "Rozstřel: ")
        ...
        self.lbl_faz_posun = tk.Label(self, text = "Posun: ")
        ...
        self.lbl_periody = tk.Label(self, text = "Periody: ")
        ...
        self.btn_vykresli = tk.Button(self, text = "GENERATE", command = self.generuj_graf, width = 19, border = 3, background = "#5e7a9e")
        self.btn_vykresli.grid(row = 6, column = 2)
        
        self.btn_vykresli_example = tk.Button(self, text = "LOAD FROM FILE", command = self.nacist, width = 19, border = 3, background = "#7d769c")
        self.btn_vykresli_example.grid(row = 7, column = 2)
        
        self.btn_quit = tk.Button(self, text="ENDOS", command=self.quit, width = 10, border = 3, background = "#8f3e99")
        self.btn_quit.grid(row =7, column = 1)


    def generuj_graf(self):
        jmeno = self.var_krivka.get()
